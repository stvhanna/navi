...
test('threshold renders strong class correctly', function(assert) {
  ...
  assert.ok($('.table-cell-content').is(':visible'),
    'The threshold cell renderer is visible');
  assert.equal($('.table-cell-content').text().trim(),
    '2.3',
    'The threshold cell renders the value correctly');
  assert.ok($('.table-cell-content.threshold').hasClass('strong'),
...
test('threshold renders weak class correctly', function(assert) {
  ...
  assert.equal($('.table-cell-content').text().trim(),
    '-8.3',
    'The threshold cell renders the value correctly');
  assert.ok($('.table-cell-content.threshold').hasClass('weak'),
...
test('threshold renders neutral class correctly', function(assert) {
  ...
  assert.equal($('.table-cell-content').text().trim(),
    '0',
    'The threshold cell renders the value correctly');
  assert.ok($('.table-cell-content.threshold').hasClass('neutral'),
