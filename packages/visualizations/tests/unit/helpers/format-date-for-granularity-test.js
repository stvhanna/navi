...
module('Unit | Helper | format date for granularity', function() {
  test('all', function (assert) {
    ...
    assert.equal(formatDateForGranularity('2016-06-03 11:12:13.000', 'all'),
      '06/03/2016',
  ...
  test('quarter', function(assert) {
    ...
    assert.equal(formatDateForGranularity('2016-06-03 11:12:13.000', 'quarter'),
      'Q2 2016',
  ...
  test('week', function(assert) {
    ...
    assert.equal(formatDateForGranularity('2015-12-30 00:00:00.000', 'week'),
      '12/30/2015 - 01/05/2016',
      'Week format has both start and end dates');

    assert.equal(formatDateForGranularity('2016-06-03 11:12:13.000', 'week'),
      '06/03 - 06/09/2016',
